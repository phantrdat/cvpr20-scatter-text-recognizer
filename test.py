...
def benchmark_all_eval(model, criterion, converter, opt, calculate_infer_time=False):
    ...
    eval_data_list = ['IIIT5k_3000', 'SVT', 'IC03_867', 'IC13_1015']
    # eval_data_list = ['IC15_2077', 'SVTP', 'CUTE80']
...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    for i, (image_tensors, labels) in enumerate(evaluation_loader):
        ...
        predss, _= model(image, text_for_pred, is_train=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensitive', action='store_true', default=False, help='for sensitive character mode')
